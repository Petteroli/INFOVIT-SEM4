[forrige](./05-attack.md)  &bullet; [oversikt](../README.md#steg-for-steg) &bullet; neste

## Oppgave 6 - Pokémon Battle
I `pokemon.Main::main`, opprett to pokemon og la de kjempe til en er bekjempet (`isAlive` returnerer `false`). <br></br>
...
### ✅ Når alle testene i `PokemonTest.java` og `PokemonBattleTest.java` passerer er laben ferdig. HUSK AT DU MÅ LEVERE PÅ CODEGRADE!
